...
const OFFLINE_TLE_TEXT = `
ISS (ZARYA)
1 25544U 98067A   24001.00000000  .00016717  00000+0  10270-3 0  9001
2 25544  51.6416  94.7161 0004318 318.1309  41.9450 15.50000000  1000
HUBBLE SPACE TELESCOPE
1 20580U 90037B   24001.00000000  .00000888  00000+0  40000-4 0  9006
2 20580  28.4695 140.1510 0002830 102.1150 258.0100 15.09200000  1001
NOAA 19
1 33591U 09005A   24001.00000000  .00000100  00000+0  90000-4 0  9008
2 33591  99.1940  30.1000 0014000 120.0000 240.0000 14.12400000  1002
GPS BIIR-2
1 24876U 97035A   24001.00000000 -.00000050  00000+0  00000+0 0  9003
2 24876  55.0000  40.0000 0100000  45.0000 315.0000  2.00560000  1003
GALILEO-PFM
1 37846U 11060A   24001.00000000 -.00000040  00000+0  00000+0 0  9002
2 37846  56.0000 250.0000 0003000  90.0000 270.0000  1.70470000  1004
`;
...
const satellitesLayer = {
  ...
  async update(viewer, { signal = null } = {}) {
    ...
    try {
      ...
      let results = await Promise.all(CATALOG_GROUPS.map(async (groupDef) => {
        try {
  ...
  getStats() {
    return {
      ...
      stale: Boolean(_lastError),
      coverage: '관측 궤도요소 기반 SGP4 계산 위치',
