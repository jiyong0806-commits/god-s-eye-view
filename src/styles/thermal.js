...
export const thermalShader = {
  name: 'thermal',
  uniforms: {
    sensitivity: { default: 0.82, min: 0, max: 1, label: '감도' },
    bloom: { default: 0.72, min: 0, max: 1, label: '열 번짐' },
    mode: { default: 0.0, min: 0, max: 1, label: '화이트/블랙 핫' },
    pixelation: { default: 1.2, min: 1, max: 6, label: '센서 해상도' },
    palette: { default: 1.0, min: 0, max: 1, label: '컬러 열화상' },
  },
  fragmentShader: /* glsl */ `
