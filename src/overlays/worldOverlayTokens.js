...
export const DETECTION_THEME_MAP = Object.freeze({
  retro: {
    ...
    tiers: {
      ...
      person: '#54ffb2', person_crowd: '#35d8ff', thermal_hot: '#ff6b1f', thermal_warm: '#ffd166',
    },
  },
  surveillance: {
    ...
    tiers: {
      ...
      person: '#76ff93', person_crowd: '#38e8ff', thermal_hot: '#ff4538', thermal_warm: '#ffc24a',
    },
  },
  thermal: {
    ...
    tiers: {
      ...
      person: '#ffffff', person_crowd: '#ffdd9a', thermal_hot: '#ffffff', thermal_warm: '#ffb000',
    },
  },
  _default: {
    ...
    tiers: {
      ...
      person: '#62f7a6', person_crowd: '#22dfff', thermal_hot: '#ff5b3a', thermal_warm: '#ffd166',
    },
  },
});
