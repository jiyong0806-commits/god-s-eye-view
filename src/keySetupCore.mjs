...
export const KEY_SETUP_KEYS = Object.freeze([
  Object.freeze({
    id: 'google-maps',
    title: 'GOOGLE MAPS',
    unlocks: '영상급 포토리얼 3D 지구/건물 + 장소 검색',
  ...
  Object.freeze({
    id: 'tomtom',
    title: 'TOMTOM',
    unlocks: '실시간 교통 흐름. 키 없으면 시뮬레이션으로 실행',
  ...
  Object.freeze({
    id: 'opensky',
    title: 'OPENSKY',
    unlocks: '항공기 호출 한도 증가. 익명 모드도 작동',
