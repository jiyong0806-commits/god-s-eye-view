...
export const CAMERA_PRESETS = {
  ...
  seoul: {
    destination: Cesium.Cartesian3.fromDegrees(126.978, 37.5665, 1200),
    orientation: {
...
/**
 * Set camera to Seoul on load for the Korean build.
 */
export function flyToSeoul(viewer) {
  viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(126.978, 37.5665, 28000),
    orientation: {
      heading: Cesium.Math.toRadians(0),
      pitch: Cesium.Math.toRadians(-90),
      roll: 0.0,
  ...
  setTimeout(() => {
    viewer.camera.flyTo({
      destination: Cesium.Cartesian3.fromDegrees(126.9841, 37.5422, 900),
      orientation: {
        heading: Cesium.Math.toRadians(20),
