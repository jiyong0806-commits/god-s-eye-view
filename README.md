# GOD'S EYE VIEW / PLASMA Working Source

This repository contains the PLASMA adaptation maintained by
[jiyong0806-commits](https://github.com/jiyong0806-commits), based on
[Bilawal Sidhu's God's Eye View](https://github.com/bilawalsidhu/gods-eye-view).
It is not the upstream author's account or an assertion of affiliation.
The original license and credits are preserved. The upstream documentation below
describes the upstream project; its publicity and feature claims are not claims
about this adaptation.

See [SOURCE-STATUS.md](SOURCE-STATUS.md) for verified results and unfinished features,
[DELIVERY.md](DELIVERY.md) for application builds, and
[CLOUDFLARE.md](CLOUDFLARE.md) for complete frontend plus API Worker deployment.
Provider authorization, payment integration and advertising approval are not supplied by this source release.
