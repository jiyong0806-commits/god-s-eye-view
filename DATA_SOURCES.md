...
| **OpenSky Network** | Optional worldwide live-flight snapshot | Written agreement required for operational REST use, including non-profit live products; commercial use also requires a license | Schäfer et al., *"Bringing Up OpenSky"*, IPSN 2014 + opensky-network.org |
...
| **SatNOGS DB** | Satellite TLE fallback when CelesTrak cannot be reached | CC BY-SA 4.0; see https://docs.satnogs.org/projects/satnogs-db/en/latest/api.html | "SatNOGS DB (CC BY-SA 4.0)" |
